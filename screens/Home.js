...
import { View, StyleSheet, SafeAreaView, Text, TouchableOpacity, Platform, StatusBar, Image } from "react-native";
            ...
            <View style = {styles.container}>
                <SafeAreaView style = {styles.droidSafeArea}>
                    ...
                    <View style = {styles.contentContainer}>
                        <View style = {{flex: 0.5}}>
                            <Text style = {styles.contentText}>Get the Virtual Experience of trying out fresh frames from our wide collection!</Text>
                        </View>
