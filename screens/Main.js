        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <TouchableOpacity onPress = {() => {this.setState({selected: `aviator`})}} style = {this.state.selected == "aviator" ? styles.categoryBoxWhenSelected : styles.categoryBox}>
                        <Text>Aviator</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => {this.setState({selected: `rimless`})}} style = {this.state.selected == "rimless" ? styles.categoryBoxWhenSelected : styles.categoryBox}>
                        <Text>Rimless</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => {this.setState({selected: `round`})}} style = {this.state.selected == "round" ? styles.categoryBoxWhenSelected : styles.categoryBox}>
                        <Text>Round</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => {this.setState({selected: `wayfarer`})}} style = {this.state.selected == "wayfarer" ? styles.categoryBoxWhenSelected : styles.categoryBox}>
                        <Text>Wayfarer</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => {this.setState({selected: `regular`})}} style = {this.state.selected == "regular" ? styles.categoryBoxWhenSelected : styles.categoryBox}>
                        <Text>Regular</Text>
                    </TouchableOpacity>
